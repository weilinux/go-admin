<template>
  <div>
    ...
    <el-button
      class="mt-1"
      style="width: 10%; margin-left: 500px"
      @click="add_host"
      >添加</el-button
    >
  </div>
  ...
  <el-table :data="hosts" style="width: 100%" height="460">
    ...
    <el-table-column fixed="right" label="功能操作" width="350">
      <template #default="scope">
        <el-button link type="primary" size="small" @click="ssh_host(scope.row)"
          >SSH</el-button
        >
        <el-button
          link
          type="primary"
          size="small"
          @click="show_host(scope.$index, scope.row)"
          >FTP</el-button
        >
        <el-button
          link
        ...
        <el-button
          ...
          type="primary"
          size="small"
          @click="edit_host(scope.$index, scope.row)"
          >编辑</el-button
        >
        <el-button
          link
          type="primary"
          size="small"
          @click="delete_host(scope.$index, scope.row)"
          >删除</el-button
        >
      </template>
    </el-table-column>
