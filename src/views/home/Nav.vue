      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-main">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/monitor/hosts">指标</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/monitor/hosts">中间件</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/monitor/hosts">日志</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/monitor/hosts">告警</a>
            </li>
            <li class="nav-item dropdown">
              <a
                class="nav-link dropdown-toggle"
