...
<!--  </div>-->
  <el-container>
    ...
    <el-container width="200px">
      <el-aside width="200px" style="align:center">
        <el-menu
            mode="vertical"
            class="aside"
            router
        ...
        <el-menu-item index="/host/add">添加</el-menu-item>
        <el-menu-item index="3-3">删除</el-menu-item>
        <el-menu-item index="/host/edit">配置</el-menu-item>
        </el-sub-menu>
        <el-sub-menu index="4">
        ...
        <el-menu-item index="8-3">注册</el-menu-item>
        <el-menu-item index="/users">管理</el-menu-item>
        </el-sub-menu>
...
<el-container>
<el-header height="50px" style="padding:0;margin:0">
<div id="header">页面主题</div>
        ...
        <el-footer height="50px" class="footer" style="padding:0">
          <div>@horse设计</div>
        </el-footer>
      </el-container>
    </el-container>
